...
export const loader = async () => {
  ...
  const requests = await Promise.allSettled([
    committees.getHearingsForDate('house', date),
    committees.getHearingsForDate('senate', date),
    floor.getActionsForDate('house', date),
    floor.getActionsForDate('senate', date),
    votes.getVotesForDate('house', date),
    votes.getVotesForDate('senate', date),
    bills.getBillsForDate('house', date),
